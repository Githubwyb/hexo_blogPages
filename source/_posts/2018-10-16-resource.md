...
- 在线画结构图等: [diagrams](https://app.diagrams.net/)
    - excalidraw，手绘风格的架构图
        - 在线画：https://excalidraw.com/
        - vscode插件也可以使用，但是注意保存
        - docker安装： `docker run -d -p 5000:80 excalidraw/excalidraw`
...
- 低价GPU算力: https://passport.compshare.cn/register?referral_code=9XehNtLsIQdFYYY8w2bxUn
...
- windows下树形查看磁盘占用: [TreeSize](https://www.jam-software.com/treesize)
