...
在 JavaScript 中，Object.create(null) 是一种创建一个没有任何原型的对象的方法。这意味着该对象不会继承 Object.prototype 的任何属性或方法。通常，使用 Object.create(null) 创建的对象被称为“干净的对象”或“无原型对象”。这种对象可以用于各种用途，尤其是在需要一个简单的映射或字典时，避免了原型链上的属性干扰。

```js
const myObject = Object.create(null);

console.log(myObject); // 输出: {}
console.log(myObject.toString); // 输出: undefined
```
