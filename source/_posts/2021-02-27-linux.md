...
### 10.4. `/proc/interrupts` cpu累积收到的硬中断次数

```
=> sudo cat /proc/interrupts
            CPU0       CPU1       CPU2       CPU3       CPU4       CPU5       CPU6       CPU7
   0:         20          0          0          0          0          0          0          0  IR-IO-APIC    2-edge      timer
   1:          0          0          0          0          0          0       9998          0  IR-IO-APIC    1-edge      i8042
   8:          0          0          0          0          0          0          0          0  IR-IO-APIC    8-edge      rtc0
   9:          0          8          0          0          0          0          0          0  IR-IO-APIC    9-fasteoi   acpi
  12:          0          0          0          0          0        140          0          0  IR-IO-APIC   12-edge      i8042
  14:          0      55570          0          0          0          0          0          0  IR-IO-APIC   14-fasteoi   INT344B:00
  16:          0          0          0          0     759315          0          0          0  IR-IO-APIC   16-fasteoi   idma64.0, i2c_designware.0, i801_smbus
 ...
 125:          0          0       5073          0         32          0          0          0  IR-PCI-MSI 327680-edge      xhci_hcd
 126:          0          0          0         17          0          0          0          0  IR-PCI-MSI 1572864-edge      nvme0q0
 127:          0          0          0          0      19640          0          0          0  IR-PCI-MSI 1572865-edge      nvme0q1
 128:          0      10107          0          0          0          0          0          0  IR-PCI-MSI 1572866-edge      nvme0q2
 129:          0          0      13191          0          0          0          0          0  IR-PCI-MSI 1572867-edge      nvme0q3
 130:          0          0          0       7165          0          0          0          0  IR-PCI-MSI 1572868-edge      nvme0q4
 131:          0          0          0          0          0       9568          0          0  IR-PCI-MSI 1572869-edge      nvme0q5
 132:          0          0          0          0          0          0      10363          0  IR-PCI-MSI 1572870-edge      nvme0q6
 133:          0          0          0          0          0          0          0       6400  IR-PCI-MSI 1572871-edge      nvme0q7
 134:          0      55570          0          0          0          0          0          0  INT344B:00   99  ETD2303:00
 135:          0          0          0          0          0          0         41          0  IR-PCI-MSI 360448-edge      mei_me
 136:          0          0          0          0          0          0          0        357  IR-PCI-MSI 1048576-edge      iwlwifi
 137:          0         12          0          0          0          0         43          0  IR-PCI-MSI 524288-edge      nvkm
 138:          0          0        103     630743          0       4805          0          0  IR-PCI-MSI 32768-edge      i915
 139:          0          0          0       1144          0          0          0          0  IR-PCI-MSI 514048-edge      snd_hda_intel:card0
 NMI:         23         23         22         22         23         22         22         24   Non-maskable interrupts
 LOC:    1949275    1734042    1936075    1538172    1801814    1862963    1854126    2040015   Local timer interrupts
 SPU:          0          0          0          0          0          0          0          0   Spurious interrupts
 PMI:         23         23         22         22         23         22         22         24   Performance monitoring interrupts
 IWI:      12652      12187      12147     310841      13382      16848      12683      11054   IRQ work interrupts
 RTR:          0          0          0          0          0          0          0          0   APIC ICR read retries
 RES:       6294      10746       6760       6099       6037       6368       5831       7977   Rescheduling interrupts
 CAL:     142829     133636     126459     119454     124950     121592     125146     125214   Function call interrupts
 TLB:      81943      78817      75641      75416      76803      74568      81688      81265   TLB shootdowns
 TRM:          0          0          0          0          0          0          0          0   Thermal event interrupts
 THR:          0          0          0          0          0          0          0          0   Threshold APIC interrupts
 DFR:          0          0          0          0          0          0          0          0   Deferred Error APIC interrupts
 MCE:          0          0          0          0          0          0          0          0   Machine check exceptions
 MCP:          6          7          7          7          7          7          7          7   Machine check polls
 ERR:          0
 MIS:          0
...
- 第一列是中断号，这个后面单独一个表格说明
- 后面几列就是这个中断号在每个cpu的累积次数了
- 最后一列是中断控制器和关联的设备
...
### 10.5. `/proc/softirqs` cpu累积收到的软中断次数

```
=> cat /proc/softirqs
                    CPU0       CPU1       CPU2       CPU3       CPU4       CPU5       CPU6       CPU7
          HI:      85496      91206      68246     774236      99925      84401      78588      64873
       TIMER:      81679      56531      55439     194830      59389      55766      55408      55580
      NET_TX:          2          0          0          1          2          1          1          0
      NET_RX:       4112       3831       4385       3805       3351       4641       4935       4283
       BLOCK:        115        116         82        167        158        273         70        162
    IRQ_POLL:          0          0          0          0          0          0          0          0
     TASKLET:        127          0       4949          1         25          2      11653         31
       SCHED:     588778     555570     531161     558175     524359     507878     504310     510537
     HRTIMER:          0          0          0          0          0          0          0          0
         RCU:     324282     324077     318224     355089     325243     321701     319715     320503
```
...
PC启动会优先寻找所有硬盘的所有分区是否有esp标记，其实就是下面的`EFI System`，用分区工具也能看到`boot,esp`标记

```shell
=> sudo fdisk -l /dev/nvme0n1
Disk /dev/nvme0n1: 119.24 GiB, 128035676160 bytes, 250069680 sectors
Disk model: WDC PC SN520 SDAPNUW-128G-1006
Units: sectors of 1 * 512 = 512 bytes
Sector size (logical/physical): 512 bytes / 512 bytes
I/O size (minimum/optimal): 512 bytes / 512 bytes
Disklabel type: gpt
Disk identifier: 26665042-C9F5-3C4E-BEAA-7215C03C71CF

Device             Start       End   Sectors  Size Type
/dev/nvme0n1p1      2048   2099199   2097152    1G EFI System
/dev/nvme0n1p2   2099200  27265023  25165824   12G Linux filesystem
/dev/nvme0n1p3  27265024 153094143 125829120   60G Linux filesystem
/dev/nvme0n1p5 153094144 250069646  96975503 46.2G Linux filesystem
```

找到这个标记的分区后，查找里面的`EFI/xxx/grubx64.efi`，显示到bootloader的引导菜单，如某一个磁盘A如下
...
会在PC的默认引导菜单（F12或其他按键进入）显示一行（多级目录不会找，所以microsoft不会显示；Boot是兼容兜底用的的也不会显示），B磁盘同样操作追加到后面。
...
### 2) 选中引导分区后，加载分区里面的`EFI/xxx/grubx64.efi`

加载这个二进制后，基于二进制里面的代码查找`grub.cfg`。二进制里面会设置prefix，也就是`grub.cfg`所在的目录。可以用strings命令查看

```shell
# archlinux上的grub-install输出如下，默认找硬盘分区3（基于配置生成）的/boot/grub
=> strings /boot/efi/EFI/GRUB/grubx64.efi | grep -i boot
...
# ubuntu上的grub-install就不一样，默认找当前esp分区的/EFI/ubuntu/下的文件，写死的
=> strings /boot/efi/EFI/GRUB/grubx64.efi | grep -i efi
...
/EFI/ubuntu
```

如果引导没进去，打开了GRUB命令行，可能是找不到`grub.cfg`。可以查看一下prefix的值并找一下里面有没有`grub.cfg`，可能目录错了

```shell
grub> echo $prefix
(hd0,gpt3)/EFI/ubuntu   # ubuntu的efi引导第一个prefix是这个
```

### 3) 加载`$prefix/grub.cfg`，进入grub引导

然后就是grub的操作了，UEFI的工作到此为止

## 2. legacy引导

Legacy引导是传统的BIOS引导方式，也称为BIOS引导或CSM(Compatibility Support Module)引导。与UEFI相比，legacy引导方式更为简单，但也有其局限性。

### 1) MBR分区表

Legacy引导使用MBR(Master Boot Record)分区表，而不是GPT。MBR有以下特点：

- MBR位于磁盘的第一个扇区(512字节)
- 包含引导代码和分区表(最多4个主分区)
- 支持的最大磁盘容量为2TB
- 分区表占用64字节，每个分区表项16字节
...
I/O size (minimum/optimal): 512 bytes / 512 bytes
Disklabel type: dos
Disk identifier: 0x000a8b6a

Device     Boot     Start       End   Sectors  Size Id Type
/dev/sda1  *         2048    999423    997376  487M 83 Linux
/dev/sda2          999424 976773119 975773696 465.3G 83 Linux
```
...
1. BIOS自检(POST)
2. BIOS查找启动设备(按照CMOS中设置的启动顺序)
3. 读取启动设备的第一个扇区(MBR)到内存0x7C00处
4. 跳转到0x7C00执行MBR中的引导代码
5. MBR引导代码查找活动分区
6. 加载活动分区的引导记录(如GRUB stage1)
7. 执行引导加载程序(如GRUB)，加载操作系统

## 3. 制作一个支持legacy+UEFI双引导的U盘或系统盘

制作一个同时支持Legacy和UEFI双引导的U盘或系统盘，结合两种引导方式的特点，按照下面的步骤执行。

### 1) 分区方案

由于uefi一定要使用gpt分区方式，而legacy重点还是在引导分区，所以我们使用gpt方式来进行分区

```shell
=> sudo fdisk /dev/sdX  # sdX是你的U盘或硬盘设备

# 创建GPT分区表
Command (m for help): g
Created a new GPT disklabel (GUID: XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX)

# 创建EFI系统分区（ESP），512M比较合适
Command (m for help): n
Partition number (1-128, default 1):
First sector (2048-XXXXXXXX, default 2048):
Last sector, +/-sectors or +/-size{K,M,G,T,P} (2048-XXXXXXXX, default XXXXXXXX): +512M
Created a new partition 1 of type 'Linux filesystem' and of size 512 MiB.

# 设置ESP分区类型，这里是重点，一定要改这个分区的type为efi，也就是esp标记分区
Command (m for help): t
Partition number (1-128, default 1):
Partition type (type L to list all types): 1
Changed type of partition 'Linux filesystem' to 'EFI System'.

# 创建BIOS启动分区（用于Legacy引导），1M即可，不用格式化
Command (m for help): n
Partition number (2-128, default 2):
First sector (XXXXXXX-XXXXXXXX, default XXXXXXX):
Last sector, +/-sectors or +/-size{K,M,G,T,P} (XXXXXXX-XXXXXXXX, default XXXXXXXX): +1M
Created a new partition 2 of type 'Linux filesystem' and of size 1 MiB.

# 设置BIOS启动分区类型，这个是legacy启动需要识别的分区类型
Command (m for help): t
Partition number (2-128, default 2):
...
# 安装GRUB2 for UEFI，后面的id用于定义引导名字，在ubuntu低版本下，这个id必须用ubuntu，因为写死了
sudo grub-install --target=x86_64-efi --efi-directory=/boot/efi --bootloader-id xxx
...
然后基本就可以用了，剩下的就看测试效果具体排查了。部分系统可能要关闭secure boot才能启动U盘里的系统
...
```shell
# 设置根目录，对应的hdx,y要用ls (hdx,y)/看是不是你对应的目录
set root=(hdx,y)
# 设置grub安装路径，也就是前缀
...
# uefi启动的按照下面这样设置，会生成到/boot/efi/EFI/GRUB/下两个文件
grub-install --target x86_64-efi --efi-directory=/boot/efi --bootloader-id GRUB
```

### 修复后如果还是一直进GRUB，可能是prefix的问题，在GRUB命令行下执行
