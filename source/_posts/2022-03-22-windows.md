...
- windows引导程序下载: https://learn.microsoft.com/zh-cn/visualstudio/install/use-command-line-parameters-to-install-visual-studio?view=vs-2022

**2. 使用命令行制造离线包**


```bat
:: product_id参考下面的连接，如windows的C++桌面合集就用 Microsoft.VisualStudio.Workload.NativeDesktop
:: lang指定语言，不指定会下载所有语言，没必要
PS D:\LocalDir> .\vs_community.exe --layout .\ --add <product_id> --lang en-US
```

- windows引导程序产品id对应: https://learn.microsoft.com/zh-cn/visualstudio/install/workload-component-id-vs-community?view=vs-2022&preserve-view=true

**3. 整个目录压缩放到离线电脑里面**

把“vs_installer.opc”解压出来，其中的“Contents”文件夹改名为“Installer”，并放到“C:\Program Files (x86)\Microsoft Visual Studio\Installer”，之后在原来创建的离线目录打开powershell运行“.\vs_setup.exe –noWeb …”（…替换成创建安装包时“–add”之后的内容，不包含“–lang”）
